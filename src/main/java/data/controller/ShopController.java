...
public class ShopController {
  ...
  @GetMapping("/")
  public ModelAndView shopHome(@RequestParam(defaultValue = "1") int currentPage,
      @RequestParam(value = "pro_id", required = false) String pro_id, HttpSession session) {
    ModelAndView mview = new ModelAndView();
    int totalCount = service.getTotalCount();
  ...
  public ModelAndView updateForm(String idx, String pro_id, String c_size,
      @RequestParam(value = "currentPage", defaultValue = "1") int currentPage, String color) {
    ModelAndView mview = new ModelAndView();

    List<ProductOpDto> list = service.getJoinNum(idx, color, pro_id, c_size);
  ...
  public String delete(String idx, String currentPage, String color, String c_size,
      HttpSession session) {

    service.deleteOne(idx, color, c_size);
  ...
  public ModelAndView stockForm(String idx, String pro_id, String c_size,
      @RequestParam(value = "currentPage", defaultValue = "1") int currentPage, String color) {
    ModelAndView mview = new ModelAndView();
