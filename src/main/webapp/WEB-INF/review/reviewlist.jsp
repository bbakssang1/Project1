...
<!-- 스타일 후기 테이블 -->
   ...
   <c:if test="${sessionScope.loginok!=null}">
    <button type="button" class="btn btn-default"
       style="width: 150px;margin-left: 950px;margin-bottom: 5px;font-size: 12px;"
            ...
            <tr>
               ...
               <pre style="background-color: #fff; border: 0px; font-weight: bold; font-size: 12pt; margin-top: 10px;">${a.content}</pre>
                  <c:if test="${a.uploadfile!='no'}">
                     <img src="../image/${a.uploadfile}" style="max-width: 150px;"><br><br>
                  </c:if> 
                  </td>
            </tr>
         </c:forEach>
...
<!--  페이징  -->
<c:if test="${totalCount>0}">
   <div style="width: 700px; text-align: center;margin-left: 400px;" class="page_wrap">
      <ul class="pagination">
         <!-- 이전 -->
   ...
   <!-- 댓글 목록 출력-->
  <br><br>
   	<h4 style="margin-left: 400px;font-weight: bold;">
      	<b>댓글</b>
   	</h4>
	   <table class="table" style="width: 700px; margin-left: 400px;">
	   <c:if test="${totalCount==0}">
         <tr height="50">
            <td colspan="5" align="center" height="150">
               <h4 style="margin-top: 50px;">
	      ...
	      <c:if test="${totalCount>0}">
	      	 <c:forEach var="a2" items="${list2}">
	   			<tr>
	               <td><img src="../photo/dae.PNG" style="max-width: 35px;max-height: 30px;">
	               <span style="font-size: 12pt;font-weight: bold;">${a2.name}</span> 
	               <br> 
