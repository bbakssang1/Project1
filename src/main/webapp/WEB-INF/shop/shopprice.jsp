                                    ...
                                    <div id="collapseSix" class="collapse show" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <div class="shop__sidebar__tags">
                                                <a href="${root}/shop/list">Product</a>
                                                <a href="${root}/shop/category?pro_sub=반팔">Short-Tshirt</a>
                                                <a href="${root}/shop/category?pro_sub=긴팔">Long-Tshirt</a>
                                                <a href="${root}/shop/category?pro_sub=코트">Coat</a>
                                                <a href="${root}/shop/category?pro_sub=스커트">Skirt</a>
                                                <a href="${root}/shop/category?pro_sub=신발">Shoes,Sneakers</a>
                                                <a href="${root}/shop/category?pro_sub=패딩">Padded Jacket</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                       ...
                       <c:forEach var="p2" items="${list2}">     
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            ...
                            <c:choose>
                                ...
                                <div class="product__item__text">      
                                    <h6>${p2.pro_name}</h6>
                                    <a href="#" class="add-cart"><p><span class="glyphicon glyphicon-eye-open"></span>&nbsp;&nbsp;${p2.readcount }</p></a>
                       ...
                       <c:forEach var="p3" items="${list3}">     
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            ...
                            <c:choose>
                                ...
                                <div class="product__item__text">      
                                    <h6>${p3.pro_name}</h6>
                                    <a href="#" class="add-cart"><p><span class="glyphicon glyphicon-eye-open"></span>&nbsp;&nbsp;${p3.readcount }</p></a>
