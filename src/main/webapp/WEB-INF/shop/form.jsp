...
class="btn btn-large-warning"><span class="glyphicon glyphicon-plus"></span> 상품 정보 입력</button>
</div>
	...
	<div class="container-fluid">
		<div style="margin-left: 50px;">
			<button data-toggle="collapse" href="#collapseExample2"
				...
				class="btn btn-large-warning"><span class="glyphicon glyphicon-plus"></span>  상품 옵션(색상) 입력</button>
		</div>
			...
			<div class="well">
				<form action="insert2" method="post" enctype="multipart/form-data">
					...
					style="width: 200px;">
						...
						<option value="cd1039">빨강</option>
						<option value="323c73">남색</option>
...
<div class="col-lg-6">
	<div>
	<table class="table table-bordered" style="width:100%; margin-left: 20px;">
	...
	<div class='mydiv' id='mydiv' style="margin-left: 20px; width:100%; font-size: 0.9em;">
	<table class="table table-bordered">
		...
		onclick="location.href='updateform?idx=${a.joindto.idx}&pro_id=${a.joindto.pro_id}&color=${a.color}&c_size=${a.c_size}'">수정</button>
				</c:otherwise>
				</c:choose>
					</td>
				</tr>
